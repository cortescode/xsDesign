...
import { data as agencyTemplateData } from '$website/templates/sites/agency/data';
import { templatesList } from '$website/templates/templatesList.js';
...
export async function POST({ request, cookies }) {
    ...
    let website: Website = {
        ...
        "sharedComponents": template.shared_components,
        "published": false,
        "config": {}
    }
    ...
    redirect(301, ("/website/" + website_id + "/designer"));
