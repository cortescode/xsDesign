...
<header>
    <div class="back-button-wrapper">
        <button
            class="back-button"
            on:click={() => (window.location.href = "/designer/" + $website.id)}
        >
    ...
    <h2 class="gradient-text">{$website.name}</h2>
</header>
<div class="main">
    <nav>
        <ul>
            ...
            <li>
                <a
                    href="./general"
                    class={route?.includes("general") ? "selected" : ""}
                    >General</a
                >
            </li>
            <li>
                <a
                    href="./images"
                    class={route?.includes("images") ? "selected" : ""}
                    >Images</a
                >
            </li>
            <li>
                <a
                    href="./domains"
                    class={route?.includes("domains") ? "selected" : ""}
                    >Domains</a
                >
            </li>
        </ul>
