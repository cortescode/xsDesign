...
import styleGradient, { GRAD_DIRS, GRAD_TYPES, getValidDir, parseGradient, toGradient } from './gradient';
...
export default function loadBackgroundStyleOptions (editor: Editor, opts = {}) {
  ...
  editor.Styles.addBuiltIn('background', {
    ...
    properties: [
      ...
      },
      {
        ...
        default: 'linear-gradient(right, #FFFFFF 0%, #000000 100%)',
        type: 'gradient',
        full: true,
      },
      {
